<p>Scales in v2.0 of Chart.js are significantly more powerful, but also different than those of v1.0.
* Multiple X &amp; Y axes are supported.
* A built-in label auto-skip feature detects would-be overlapping ticks and labels and removes every nth label to keep things displaying normally.
* Scale titles are supported
* New scale types can be extended without writing an entirely new chart type</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Object</td>
      <td>-</td>
      <td>See <a href="#scales-grid-line-configuration">grid line configuration</a> section.</td>
    </tr>
    <tr>
      <td><strong>scaleLabel</strong></td>
      <td>Object</td>
      <td> </td>
      <td>See <a href="#scales-scale-title-configuration">scale title configuration</a> section.</td>
    </tr>
    <tr>
      <td><strong>ticks</strong></td>
      <td>Object</td>
      <td> </td>
      <td>See <a href="#scales-ticks-configuration">ticks configuration</a> section.</td>
    </tr>
  </tbody>
</table>

<h4 id="grid-line-configuration">Grid Line Configuration</h4>

<p>The grid line configuration is nested under the scale configuration in the <code class="highlighter-rouge">gridLines</code> key. It defines options for the grid lines that run perpendicular to the axis.</p>
...
<h4 id="scale-title-configuration">Scale Title Configuration</h4>

<p>The grid line configuration is nested under the scale configuration in the <code class="highlighter-rouge">scaleLabel</code> key. It defines options for the scale title.</p>
...
<h4 id="tick-configuration">Tick Configuration</h4>

<p>The grid line configuration is nested under the scale configuration in the <code class="highlighter-rouge">ticks</code> key. It defines options for the tick marks that are generated by the axis.</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>callback</td>
      <td>Function</td>
      <td><code class="highlighter-rouge">function(value) { return helpers.isArray(value) ? value : '' + value; }</code></td>
...
<h4 id="creating-custom-tick-formats">Creating Custom Tick Formats</h4>

<p>The <code class="highlighter-rouge">callback</code> method may be used for advanced tick customization. In the following example, every label of the Y axis would be displayed in scientific notation.</p>

<p>If the callback returns <code class="highlighter-rouge">null</code> or <code class="highlighter-rouge">undefined</code> the associated grid line will be hidden.</p>

<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">chartInstance</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Chart</span><span class="p">(</span><span class="nx">ctx</span><span class="p">,</span> <span class="p">{</span>
        ...
        <span class="na">scales</span><span class="p">:</span> <span class="p">{</span>
            <span class="na">yAxes</span><span class="p">:</span> <span class="p">[{</span>
                <span class="na">ticks</span><span class="p">:</span> <span class="p">{</span>
                    <span class="c1">// Create scientific notation labels</span>
                    <span class="na">callback</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">value</span><span class="p">,</span> <span class="nx">index</span><span class="p">,</span> <span class="nx">values</span><span class="p">)</span> <span class="p">{</span>
                        <span class="k">return</span> <span class="nx">value</span><span class="p">.</span><span class="nx">toExponential</span><span class="p">();</span>
                    <span class="p">}</span>
                <span class="p">}</span>
            <span class="p">}]</span>
        <span class="p">}</span>
...
<h3 id="category-scale">Category Scale</h3>

<p>The category scale will be familiar to those who have used v1.0. Labels are drawn in from the labels array included in the chart data.</p>

<h4 id="configuration-options">Configuration Options</h4>

<p>The category scale has the following additional options that can be set.</p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>String</td>
      <td>-</td>
      <td>The minimum item to display. Must be a value in the <code class="highlighter-rouge">labels</code> array</td>
    </tr>
    <tr>
      <td>ticks.max</td>
      <td>String</td>
      <td>-</td>
      <td>The maximum item to display. Must be a value in the <code class="highlighter-rouge">labels</code> array</td>
    </tr>
    <tr>
      <td>gridLines.offsetGridLines</td>
      <td>Boolean</td>
      <td>-</td>
...
<h3 id="linear-scale">Linear Scale</h3>
...
<p>The following options are provided by the linear scale. They are all located in the <code class="highlighter-rouge">ticks</code> sub options.</p>
        ...
        <span class="na">scales</span><span class="p">:</span> <span class="p">{</span>
            <span class="na">yAxes</span><span class="p">:</span> <span class="p">[{</span>
                <span class="na">ticks</span><span class="p">:</span> <span class="p">{</span>
                    ...
                    <span class="na">stepSize</span><span class="p">:</span> <span class="mf">0.5</span>
                <span class="p">}</span>
            <span class="p">}]</span>
        <span class="p">}</span>
    <span class="p">}</span>
...
<h3 id="logarithmic-scale">Logarithmic Scale</h3>
...
<p>The following options are provided by the logarithmic scale. They are all located in the <code class="highlighter-rouge">ticks</code> sub options.</p>
...
<p>The following example creates a chart with a logarithmic X axis that ranges from 1 to 1000.</p>
    ...
    <span class="na">options</span><span class="p">:</span> <span class="p">{</span>
        <span class="na">scales</span><span class="p">:</span> <span class="p">{</span>
            <span class="na">xAxes</span><span class="p">:</span> <span class="p">[{</span>
                <span class="na">type</span><span class="p">:</span> <span class="s1">'logarithmic'</span><span class="p">,</span>
                ...
                <span class="na">ticks</span><span class="p">:</span> <span class="p">{</span>
                    ...
                    <span class="na">max</span><span class="p">:</span> <span class="mi">1000</span>
                <span class="p">}</span>
            <span class="p">}]</span>
        <span class="p">}</span>
    <span class="p">}</span>
...
<p>The time scale is used to display times and dates. It can only be placed on the X axis. When building its ticks, it will automatically calculate the most comfortable unit base on the size of the scale.</p>

<h4 id="configuration-options-3">Configuration Options</h4>

<p>The following options are provided by the logarithmic scale. They are all located in the <code class="highlighter-rouge">time</code> sub options.</p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Object</td>
      <td>-</td>
      <td>See <a href="#scales-display-formats">Display Formats</a> section below.</td>
    </tr>
    <tr>
      <td>isoWeekday</td>
      <td>Boolean</td>
    ...
    <tr>
      <td>max</td>
      <td><a href="#scales-date-formats">Time</a></td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>String</td>
      <td>-</td>
      <td>If defined, dates will be rounded to the start of this unit. See <a href="#scales-time-units">Time Units</a> below for the allowed units.</td>
    </tr>
    <tr>
      <td>tooltipFormat</td>
      <td>String</td>
    ...
    <tr>
      ...
      <td>String</td>
      <td>-</td>
      <td>If defined, will force the unit to be a certain type. See <a href="#scales-time-units">Time Units</a> section below for details.</td>
    </tr>
    <tr>
      <td>unitStepSize</td>
      <td>Number</td>
...
<p>When providing data for the time scale, Chart.js supports all of the formats that Moment.js accepts. See <a href="http://momentjs.com/docs/#/parsing/">Moment.js docs</a> for details.</p>

<h4 id="display-formats">Display Formats</h4>

<p>The following display formats are used to configure how different time units are formed into strings for the axis tick marks. See <a href="http://momentjs.com/docs/#/displaying/format/">moment.js</a> for the allowable format strings.</p>
        ...
        <span class="na">scales</span><span class="p">:</span> <span class="p">{</span>
            <span class="na">xAxes</span><span class="p">:</span> <span class="p">[{</span>
                ...
                <span class="na">time</span><span class="p">:</span> <span class="p">{</span>
                    <span class="na">displayFormats</span><span class="p">:</span> <span class="p">{</span>
                        <span class="na">quarter</span><span class="p">:</span> <span class="s1">'MMM YYYY'</span>
                    <span class="p">}</span>
                <span class="p">}</span>
            <span class="p">}]</span>
        <span class="p">}</span>
...
<p>The following time measurements are supported. The names can be passed as strings to the <code class="highlighter-rouge">time.unit</code> config option to force a certain unit.</p>
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">chartInstance</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Chart</span><span class="p">(</span><span class="nx">ctx</span><span class="p">,</span> <span class="p">{</span>
    ...
    <span class="na">options</span><span class="p">:</span> <span class="p">{</span>
        <span class="na">scales</span><span class="p">:</span> <span class="p">{</span>
            <span class="na">xAxes</span><span class="p">:</span> <span class="p">[{</span>
                <span class="na">time</span><span class="p">:</span> <span class="p">{</span>
                    <span class="na">unit</span><span class="p">:</span> <span class="s1">'month'</span>
                <span class="p">}</span>
            <span class="p">}]</span>
        <span class="p">}</span>
    <span class="p">}</span>
...
<h3 id="radial-linear-scale">Radial Linear Scale</h3>

<p>The radial linear scale is used specifically for the radar and polar are chart types. It overlays the chart area, rather than being positioned on one of the edges.</p>
...
<h4 id="angle-line-options">Angle Line Options</h4>

<p>The following options are used to configure angled lines that radiate from the center of the chart to the point labels. They can be found in the <code class="highlighter-rouge">angleLines</code> sub options. Note that these options only apply if <code class="highlighter-rouge">lineArc</code> is false.</p>
...
<h4 id="point-label-options">Point Label Options</h4>

<p>The following options are used to configure the point labels that are shown on the perimeter of the scale. They can be found in the <code class="highlighter-rouge">pointLabels</code> sub options. Note that these options only apply if <code class="highlighter-rouge">lineArc</code> is false.</p>
...
<h4 id="tick-options">Tick Options</h4>
...
<h3 id="update-default-scale-config">Update Default Scale config</h3>

<p>The default configuration for a scale can be easily changed using the scale service. Pass in a partial configuration that will be merged with the current scale default configuration.</p>

<p>For example, to set the minimum value of 0 for all linear scales, you would do the following. Any linear scales created after this time would now have a minimum of 0.
